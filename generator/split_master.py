...
"""
./Clustered-Cervical-Cell-ImageMask-Dataset/
├─test
│  ├─images
│  └─masks
├─train
...
if __name__ == "__main__":
  try:
    ...
    images_dir = "./Pre-Augmented-CNSeg-ClusteredCell-master/images"
    masks_dir  = "./Pre-Augmented-CNSeg-ClusteredCell-master/masks"
    output_dir = "./Clustered-Cervical-Cell-ImageMask-Dataset/"
